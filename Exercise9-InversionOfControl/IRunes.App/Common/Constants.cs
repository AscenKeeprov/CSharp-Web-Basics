namespace IRunes.App.Common
{
	...
	public const string HtmlIframeTag =
	    "<iframe class='embed-responsive-item' width='{0}' height='{1}' src='{2}' frameborder='0' allowfullscreen></iframe>\r\n";
	...
	public const string PageTitlePlaceholder = "@PageTitle";
	...
	public const string UnauthorizedAccessError = "Unauthorized access! Please login/register first.";
	public const string UnauthorizedViewRoute = "/Unauthorized";
