...
namespace SIS.WebServer
{
	...
	private IControllerHandler ControllerRouter => services.GetService<IControllerHandler>();
	private IResourceHandler ResourceRouter => services.GetService<IResourceHandler>();
