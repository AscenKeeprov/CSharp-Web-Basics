...
namespace SIS.HTTP.Cookies
{
	...
	public HttpCookie(string name, string value,
	    int lifetimeInDays = Constants.HttpCookieDefaultLifetimeInDays,
	    int maxAge = Constants.HttpCookieDefaultMaxAgeInSeconds,
	    string path = Constants.HttpCookieDefaultPath,
