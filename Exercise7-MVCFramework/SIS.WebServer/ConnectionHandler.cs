...
namespace SIS.WebServer
{
	...
	private IHttpHandler ControllerRouter => (IHttpHandler)services
	    .GetService(typeof(IHttpHandler));
	...
	public async Task ProcessRequestAsync()
	{
		...
		//TODO: SWITCHING TO MVC FRAMEWORK
		//var httpResponse = HandleRequest(httpRequest);
		var httpResponse = ControllerRouter.Handle(httpRequest);
