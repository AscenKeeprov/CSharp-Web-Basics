...
namespace SIS.WebServer
{
	...
	private IControllerHandler ControllerRouter => (IControllerHandler)services
	    .GetService(typeof(IControllerHandler));
	private IResourceHandler ResourceRouter => (IResourceHandler)services
	    .GetService(typeof(IResourceHandler));
